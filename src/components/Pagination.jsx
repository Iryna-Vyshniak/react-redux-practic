...
export const Pagination = ({ setSearchParams, currentPage, totalPages }) => {
  ...
  return (
    <ReactPaginate
      ...
      activeClassName='selected bg-[var(--pagination-btn)] rounded-full'
      ...
      activeLinkClassName='border-solid border-2 border-white rounded-full bg-[var(--pagination-btn)]  text-accent hover:scale-105 transition-scale duration-200 ease-in-out'
