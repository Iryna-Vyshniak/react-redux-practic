const Footer = () => {
  return (
    <footer className=' sm:flex sm:items-center sm:justify-between mt-auto p-4 sm:p-6 xl:p-8w-full bg-white rounded-lg shadow dark:bg-gray-800'>
      <p className='mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0'>
        &copy; <span className='mr-2'>{new Date().toLocaleDateString()}</span>
        <a
